    ...
    return (
      <>
          ...
          {showImage && <Routes>
              ...
              <Route path="/AutoLoook_ReactJS_WEB_Project/car/:id" element={<ProtectedRoute element={CarDetails} />} />
              <Route path="/AutoLoook_ReactJS_WEB_Project/create-item" element={<ProtectedRoute element={AddItem} />} />
