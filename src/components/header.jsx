      ...
      <Navbar className="custom-navbar" variant="dark" expand="lg" fixed="top" style={{ marginBottom: '2%' }}>
          ...
          <Navbar.Collapse id="navbarNavDropdown">
              ...
              <Nav className="nav-center">
                  <Nav.Link as={Link} to="/AutoLoook_ReactJS_WEB_Project/file-upload">File upload
                  </Nav.Link>
              </Nav>
              </Nav>
              <Nav className="nav-right">
                  {isAuthenticated() ? (
                    <>
                        <Nav.Link as={Link} to={`/AutoLoook_ReactJS_WEB_Project/user-profile/${user.id}`}>
                            <Image
                        ...
                        <Nav.Link as={Link} to="/AutoLoook_ReactJS_WEB_Project/logout">Logout</Nav.Link>
                    </>
                  ) : (
                    <>
